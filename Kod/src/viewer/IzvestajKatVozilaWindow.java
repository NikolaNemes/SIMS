...
public class IzvestajKatVozilaWindow extends JFrame {
    ...
    IzvestajKatVozilaWindow(Model model, TipIzvestaja tipIzvestaja){
        setSize(800,600);
        ...
        napraviIzvestajDugme.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (tipIzvestaja.equals(TipIzvestaja.BROJ_VOZILA)) {
                    izvestaj = model.izvestajBrojVozilaKat(pocetniDatumIzbor.getDate(), krajnjiDatumIzbor.getDate(),
                            kategorijaVozilaComboBox.getItemAt(kategorijaVozilaComboBox.getSelectedIndex()));
                }else{
                    izvestaj = model.izvestajNovcaKat(pocetniDatumIzbor.getDate(), krajnjiDatumIzbor.getDate(),
                            kategorijaVozilaComboBox.getItemAt(kategorijaVozilaComboBox.getSelectedIndex()));
                }
